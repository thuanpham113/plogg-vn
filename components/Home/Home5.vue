<template>
  <v-sheet color:="white">
    <v-row>
		<v-img v-if="$vuetify.breakpoint.mdAndUp" contain aspect-ratio="1" :max-width="$vuetify.breakpoint.smAndDown ? '20%' : '31%'" src="Strengthen.jpg"></v-img>
		<v-col>
          ...
          {{ $t("title.2") }}
				...
				<v-col>
					...
					<v-img contain aspect-ratio="1" :max-width="$vuetify.breakpoint.smAndDown ? '30%' : ''" src="Strengthen2.jpg" />
					<v-img v-if="$vuetify.breakpoint.smAndDown" contain aspect-ratio="1" :max-width="$vuetify.breakpoint.smAndDown ? '30%' : ''" src="Strengthen.jpg"></v-img>
					</v-row>
				</v-col>
      </v-layout>
		</v-col>
