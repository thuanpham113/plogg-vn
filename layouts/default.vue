  ...
  <v-app id="app" style="overflow: scroll">
    ...
    >
      <v-col class="d-flex align-center justify-md-center">
        <nuxt-link to="/">
          <v-img width="105" contain src="/logo_ploggvn.svg"></v-img>
        </nuxt-link>
      </v-col>
    ...
    >
      <v-layout column>
        ...
        <kq-button-locale height="10vh" color=" grey" />
      </v-layout>
    </v-navigation-drawer>
    ...
    <v-footer color="white" class="white--text font-weight-light">
      <v-layout column>
        <v-layout
        ...
        >
          <v-col :cols="$vuetify.breakpoint.smAndDown ? '9 ml-2 pb-10' : '3'">
            <v-row v-for="(text, index) in texts" :key="index">
              ...
              <v-img max-width="30" contain :src="text.img" />
